...
Installation
============
The Atomic Charges step is probably already installed in your SEAMM
...
check for `atomic-charges-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update atomic-charges-step
