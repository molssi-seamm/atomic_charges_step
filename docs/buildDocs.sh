...
do
	...
	sphinx-apidoc -o docs/developer atomic_charges_step
...
<html>
   <head>
      <title>Documentation for the Atomic Charges plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the Atomic Charges plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
